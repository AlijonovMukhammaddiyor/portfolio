								...
								<div className="data">
									<div className="kaist">
										...
										<div className="courses">
											...
											<ul>
												...
												<li>
													<span className="course_code">CS206 </span> - Data Structures and
													Algorithms
												</li>
									...
									<div className="chonnam univ">
										...
										<div className="univ_name">
											<h2>
												<a
													href="https://www.jnu.ac.kr/jnumain.aspx"
													target="_blank"
													rel="noreferrer"
												>
							...
							<div className="about_msg">
								...
								<div className="languages">
									...
									<div className="language ml">
										...
										<p className="desc">
											I am a motivated Machine Learning enthusiast. At KAIST, I have already taken
											two major AI courses, and have finished a few online courses as I have stated
											in Online Courses section. Here are some of (but not limited to) algorithms I
											have learned:
										</p>
										<div className="libraries">
											<ul>
									...
									<div className="language python">
										...
										<p className="desc">
											I have been coding in Python for about 2 years. Over the period, I have
											finished several Python books and courses and built some projects including
											small games and puzzles. Here are the some of the Python libraries I am
											familiar with:
										</p>
										<div className="libraries">
											<ul>
									...
									<div className="language others">
										...
										<p className="desc">
											...
											at KAIST. Since C++ was my first and favourite language, I am quite good at
											Java and C while I have not done any noteworthy project using Haskell.
										</p>
									</div>
								</div>
							</div>
